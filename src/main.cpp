        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
          	...
          	//This helps for doing smooth transitions
          	int prev_size = previous_path_x.size();
          	
          	/*********BEGIN AVOID COLLISION ***********/
          	if(prev_size > 0)
          	{
          	  car_s = end_path_s;
          	}
        	...
        	too_close = false;
          	...
          	//later we will interpolate these points using a spline and create a bunch of control points in between
          	
          	vector<double> ptsx;
          	vector<double> ptsy;
          	
          	//reference x, y, yaw states
          	//we will reference the starting points at where the car is or at the previous end point
          	double ref_x = car_x;
          	double ref_y = car_y;
          	double ref_yaw = deg2rad(car_yaw);
          	
          	//if previous size is almost empty, we use car as the starting reference
          	if(prev_size<2)
          	{
          	...
          	else
          	{
          	  ...
          	  //use two points that make the path tangent to the previous end points
          	...
          	//rotate and translate to be in local car coordinates (car is 0)
          	for(int i = 0; i < ptsx.size(); i++)
          	{
          	  //shift heading so angle is 0 degrees
            ...
            //Define the actual (x,y) points to be used in the planner
            vector<double> next_x_vals;
          	vector<double> next_y_vals;
          	
          	//if I still ahve prev path points, add them to the list so that the future is a cont of the past
          	...
          	//calculate how to break up spline points so we travel at the desired speed
